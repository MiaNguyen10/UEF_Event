...
class FOTourism extends Component {
  constructor(props) {
    super(props);
    this.state = {
      modalIsOpen: false,
    ...
    return (
      <div className="homepage">
        ...
        <div className="event-des">
          ...
          {this.state.event.filter(u => u.organizationalUnit.includes("Khoa Quản trị du lịch - Khách sạn")).map((item) => (
