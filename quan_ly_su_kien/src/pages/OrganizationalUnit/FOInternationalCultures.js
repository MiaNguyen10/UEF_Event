...
class FOInternationalCultures extends Component {
  constructor(props) {
    super(props);
    this.state = {
      modalIsOpen: false,
    ...
    return (
      <div className="homepage">
        ...
        <div className="event-des">
          ...
          {this.state.event.filter(u => u.organizationalUnit.includes("Khoa Ngôn ngữ và Văn hóa quốc tế")).map((item) => (
...
export default FOInternationalCultures;